...
geom_bar_flipped_RR <- function(){
  list(geom_bar_RR(),
       ggplot2::theme(panel.grid.major.x = ggplot2::element_line(color = scales::alpha(RR_dark_blue, 0.5),
...
geom_point_RR <- function(..., size = 2.5){
  list(ggplot2::geom_point(size = size),
       ggplot2::theme(panel.grid.major.x = ggplot2::element_line(color = scales::alpha(RR_dark_blue, 0.5),
                                                        linewidth = ggplot2::rel(1.75),
                                                        linetype = "dotted", size = 0.6),
                      panel.grid.major.y = ggplot2::element_line(color = scales::alpha(RR_dark_blue, 0.5),
                                                        linewidth = ggplot2::rel(1.75),
                                                        linetype = "dotted", size = 0.6)),
